  ...
  return (
    <div className="min-h-screen bg-red-50 flex flex-col items-center justify-center">
      <div className="bg-white p-8 rounded-3xl shadow-lg text-center max-w-lg">
        ...
        <Link to="/" className="bg-red-500 text-white py-3 px-6 rounded-full shadow-lg hover:bg-red-600 transition-transform transform hover:scale-105 font-semibold text-lg">
          Go to Home Page
        </Link>
      </div>
    </div>
